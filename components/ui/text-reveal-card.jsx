...
export const TextRevealCard = ({
  ...
  return (
    (<div
      ...
      ref={cardRef}
      className={cn(
        "bg-slate-950 border-white/[0.08] w-[50rem] rounded-lg p-8 relative overflow-hidden",
        className
      )}>
      {children}
      <div className="h-40  relative flex items-center overflow-hidden">
        <motion.div
          ...
          <p
            ...
            className="text-base md:text-[2rem] lg:text-[3rem] py-10 font-bold text-white bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-300">
            {revealText}
          </p>
        </motion.div>
        <motion.div
        ...
        <div
          ...
          <p
            className="text-base md:text-[2rem] lg:text-[3rem] py-10 font-bold bg-clip-text text-transparent bg-[#42424d]">
            {text}
          </p>
          <MemoizedStars />
        </div>
