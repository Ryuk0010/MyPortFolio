      ...
      <div className="h-40 relative flex items-center overflow-hidden">
        <motion.div
          ...
          <p
            ...
            className="text-3xl md:text-[2rem] lg:text-[3rem] py-10 font-bold text-white bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-300">
            {revealText}
          </p>
        </motion.div>
        <motion.div
        ...
        <div
          ...
          <p
            className="text-3xl md:text-[2rem] lg:text-[3rem] py-10 font-bold bg-clip-text text-transparent bg-[#8b8ba3]">
            {text}
          </p>
          <MemoizedStars />
        </div>
